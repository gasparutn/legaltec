"use strict";
function getAutoridadMetadata(autoridad) {
    ...
    if (senadores.includes(upperAutoridad))
        return { tipo: 'senador', nombre: mapeo[upperAutoridad] || upperAutoridad };
    if (senadoras.includes(upperAutoridad))
        return { tipo: 'senadora', nombre: mapeo[upperAutoridad] || upperAutoridad };
