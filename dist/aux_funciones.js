 ...
 */
function calculateAuxColumns(rowDataRaw) {
    ...
    if (sexoC === 'el Sr.')
        ...
        aux['AUX4'] = 'LA LOCADORA';
    else
        aux['AUX4'] = '';
    // aux5: "por el Senador" , "por la Senadora", ""
    if (isSenadora)
        aux['AUX5'] = 'por la Senadora';
    else if (isSenador)
        aux['AUX5'] = 'por el Senador';
    else
        aux['AUX5'] = 'por'; // Secretaría / Vice
    // aux6: "por el contratado" o "por la contratada"
    if (sexoC === 'el Sr.')
        aux['AUX6'] = 'por el contratado';
    else if (sexoC === 'la Sra.')
        aux['AUX6'] = 'por la contratada';
    else
        aux['AUX6'] = '';
    // aux7: "el Senador" , "la Senadora", ""
    if (isSenadora)
        aux['AUX7'] = 'la Senadora';
    else if (isSenador)
        aux['AUX7'] = 'el Senador';
    else
        aux['AUX7'] = '';
    ...
    if (isSenadora)
        aux['AUX8'] = 'de la Senadora';
    else if (isSenador)
        aux['AUX8'] = 'del Senador';
    else
        aux['AUX8'] = 'de'; // Secretaría / Vice
    ...
    const padNum = (n) => (n > 0 && n < 10) ? '0' + n : String(n);
