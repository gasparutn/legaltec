////////////////////////// CONVERSION DE NUEMEROS A LETRAS ////////////////////////
////////////////////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////////////////////
...
function Miles(num) {
  ...
  return [strMiles, strCentenas].filter(s => !!s).join(" ").trim();
} //Miles()
...
function Millones(num) {
  ...
  if (strMillones == "MILLONES")
    return strMiles.trim();

  return [strMillones, strMiles].filter(s => !!s).join(" ").trim();
}//Millones()
...
function NumeroALetras(num) {
  var data = {
    ...
    letrasMonedaSingular: '', //“PESOS”, 'Dólar', 'Bolivar', 'etc'
